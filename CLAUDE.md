...
- NEXT: Phase 6 (CI/CD workflows: ci.yml, deploy-infra.yml, deploy-app.yml, configure.yml) OR Phase 7 (ops scripts: install-aem.sh, harden.sh, backup-packages.sh). Phase 8 = real AWS apply
